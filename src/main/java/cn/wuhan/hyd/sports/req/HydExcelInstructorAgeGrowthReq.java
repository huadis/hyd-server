...
@Getter
@Setter
@Table(name = "hyd_excel_instructor_age_growth")
public class HydExcelInstructorAgeGrowthReq implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelInstructorAgeGrowthReq that = (HydExcelInstructorAgeGrowthReq) o;
