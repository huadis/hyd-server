...
@Getter
@Setter
@Table(name = "hyd_result_coupon_amount_history")
public class HydResultCouponAmountHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultCouponAmountHistory that = (HydResultCouponAmountHistory) o;
