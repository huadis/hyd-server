...
@Getter
@Setter
@Table(name = "hyd_result_la_stadium_sport_name")
public class HydResultLaStadiumSportName implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultLaStadiumSportName that = (HydResultLaStadiumSportName) o;
