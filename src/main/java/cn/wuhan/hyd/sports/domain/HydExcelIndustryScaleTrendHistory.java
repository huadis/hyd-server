...
@Getter
@Setter
@Table(name = "hyd_excel_industry_scale_trend_history")
public class HydExcelIndustryScaleTrendHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryScaleTrendHistory that = (HydExcelIndustryScaleTrendHistory) o;
