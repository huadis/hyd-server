...
@Getter
@Setter
@Table(name = "hyd_tenant_history")
public class HydTenantHistory implements Serializable {
    ...
    @Column(name = "businessLicenseling", length = 256)
    @ApiModelProperty(value = "营业执照")
    private String businessLicenseling;
    ...
    public boolean equals(Object o) {
        ...
        HydTenantHistory hydTenant = (HydTenantHistory) o;
        return Objects.equals(id, hydTenant.id);
    }
