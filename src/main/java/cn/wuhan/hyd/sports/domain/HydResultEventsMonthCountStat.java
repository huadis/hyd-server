...
@Getter
@Setter
@Table(name = "hyd_result_events_month_count_stat")
public class HydResultEventsMonthCountStat implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultEventsMonthCountStat that = (HydResultEventsMonthCountStat) o;
