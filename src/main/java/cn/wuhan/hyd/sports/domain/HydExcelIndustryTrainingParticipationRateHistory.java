...
@Getter
@Setter
@Table(name = "hyd_excel_industry_training_participation_rate_history")
public class HydExcelIndustryTrainingParticipationRateHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryTrainingParticipationRateHistory that = (HydExcelIndustryTrainingParticipationRateHistory) o;
