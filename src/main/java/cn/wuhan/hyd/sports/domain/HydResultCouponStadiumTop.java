...
@Getter
@Setter
@Table(name = "hyd_result_coupon_stadium_top")
public class HydResultCouponStadiumTop implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultCouponStadiumTop that = (HydResultCouponStadiumTop) o;
