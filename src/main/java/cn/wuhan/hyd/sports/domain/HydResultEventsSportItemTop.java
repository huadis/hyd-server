...
@Getter
@Setter
@Table(name = "hyd_result_events_sport_item_top")
public class HydResultEventsSportItemTop implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultEventsSportItemTop that = (HydResultEventsSportItemTop) o;
