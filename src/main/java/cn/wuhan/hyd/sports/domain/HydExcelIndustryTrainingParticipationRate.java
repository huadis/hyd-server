...
@Getter
@Setter
@Table(name = "hyd_excel_industry_training_participation_rate")
public class HydExcelIndustryTrainingParticipationRate implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryTrainingParticipationRate that = (HydExcelIndustryTrainingParticipationRate) o;
