...
@Getter
@Setter
@Table(name = "hyd_result_stock_history")
public class HydResultStockHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultStockHistory that = (HydResultStockHistory) o;
