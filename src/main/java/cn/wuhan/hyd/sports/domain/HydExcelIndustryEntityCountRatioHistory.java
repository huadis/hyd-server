...
@Getter
@Setter
@Table(name = "hyd_excel_industry_entity_count_ratio_history")
public class HydExcelIndustryEntityCountRatioHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryEntityCountRatioHistory that = (HydExcelIndustryEntityCountRatioHistory) o;
