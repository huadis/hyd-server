...
@Getter
@Setter
@Table(name = "hyd_industry_entity_count_ratio")
public class HydIndustryEntityCountRatio implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydIndustryEntityCountRatio that = (HydIndustryEntityCountRatio) o;
