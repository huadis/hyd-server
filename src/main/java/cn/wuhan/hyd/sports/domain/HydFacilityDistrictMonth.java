...
@Getter
@Setter
@Table(name = "hyd_facility_district_month")
public class HydFacilityDistrictMonth implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydFacilityDistrictMonth that = (HydFacilityDistrictMonth) o;
