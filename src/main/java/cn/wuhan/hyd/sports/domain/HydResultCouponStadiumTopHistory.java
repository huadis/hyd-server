...
/**
 * 功能说明：结果表（历史）-场馆预定/体育消费卷-消费券场馆预订Top <br>
...
@Getter
@Setter
@Table(name = "hyd_result_coupon_stadium_top_history")
public class HydResultCouponStadiumTopHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultCouponStadiumTopHistory that = (HydResultCouponStadiumTopHistory) o;
