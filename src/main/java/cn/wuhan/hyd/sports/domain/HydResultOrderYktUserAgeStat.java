...
@Getter
@Setter
@Table(name = "hyd_result_order_ykt_userage_stat")
public class HydResultOrderYktUserAgeStat implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultOrderYktUserAgeStat that = (HydResultOrderYktUserAgeStat) o;
