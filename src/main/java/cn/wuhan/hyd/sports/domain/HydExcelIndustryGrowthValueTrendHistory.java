...
@Getter
@Setter
@Table(name = "hyd_excel_industry_growth_value_trend_history")
public class HydExcelIndustryGrowthValueTrendHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryGrowthValueTrendHistory that = (HydExcelIndustryGrowthValueTrendHistory) o;
