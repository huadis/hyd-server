...
@Getter
@Setter
@Table(name = "hyd_origin_tenant_history")
public class HydOriginTenantHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTenantHistory hydTenant = (HydOriginTenantHistory) o;
