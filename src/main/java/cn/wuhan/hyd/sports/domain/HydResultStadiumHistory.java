...
@Getter
@Setter
@Table(name = "hyd_result_stadium_history")
public class HydResultStadiumHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultStadiumHistory that = (HydResultStadiumHistory) o;
