...
@Getter
@Setter
@Table(name = "hyd_result_stadium_map_point_history")
public class HydResultStadiumMapPointHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultStadiumMapPointHistory that = (HydResultStadiumMapPointHistory) o;
