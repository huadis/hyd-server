...
@Getter
@Setter
@Table(name = "hyd_result_user_repurchase_history")
public class HydResultUserRepurchaseHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultUserRepurchaseHistory that = (HydResultUserRepurchaseHistory) o;
