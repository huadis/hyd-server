...
@Getter
@Setter
@Table(name = "hyd_result_instructor_service_project")
public class HydResultInstructorServiceProject implements Serializable {
    ...
    @Column(name = "totalPersonCount")
    @ApiModelProperty(value = "人数")
    private Long totalPersonCount;

    @Column(name = "newPersonCount")
    @ApiModelProperty(value = "新增人数")
    private Long newPersonCount;
    ...
    public boolean equals(Object o) {
        ...
        HydResultInstructorServiceProject that = (HydResultInstructorServiceProject) o;
