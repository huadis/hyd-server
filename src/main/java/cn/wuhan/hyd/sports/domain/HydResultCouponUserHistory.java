...
@Getter
@Setter
@Table(name = "hyd_result_coupon_user_history")
public class HydResultCouponUserHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultCouponUserHistory that = (HydResultCouponUserHistory) o;
