...
@Getter
@Setter
@Table(name = "hyd_origin_la_stadium_history")
public class HydOriginLaStadiumHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginLaStadiumHistory that = (HydOriginLaStadiumHistory) o;
