...
@Getter
@Setter
@Table(name = "hyd_result_la_stadium_district")
public class HydResultLaStadiumDistrict implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultLaStadiumDistrict that = (HydResultLaStadiumDistrict) o;
