...
@Getter
@Setter
@Table(name = "hyd_result_instructor_usersex")
public class HydResultInstructorUserSex implements Serializable {
    ...
    @Column(name = "gender")
    @ApiModelProperty(value = "性别（如：男、女）")
    private String gender;

    @Column(name = "personCount")
    @ApiModelProperty(value = "数量（对应性别的指导员人数）")
    ...
    public boolean equals(Object o) {
        ...
        HydResultInstructorUserSex that = (HydResultInstructorUserSex) o;
