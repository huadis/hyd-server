...
@Getter
@Setter
@Table(name = "hyd_result_coupon_user_age_history")
public class HydResultCouponUserAgeHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultCouponUserAgeHistory that = (HydResultCouponUserAgeHistory) o;
