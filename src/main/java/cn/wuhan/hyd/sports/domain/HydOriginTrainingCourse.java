...
@Getter
@Setter
@Table(name = "hyd_origin_training_course")
public class HydOriginTrainingCourse implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTrainingCourse that = (HydOriginTrainingCourse) o;
