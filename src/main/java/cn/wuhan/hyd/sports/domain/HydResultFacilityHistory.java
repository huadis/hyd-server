...
@Getter
@Setter
@Table(name = "hyd_result_facility_history")
public class HydResultFacilityHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultFacilityHistory that = (HydResultFacilityHistory) o;
