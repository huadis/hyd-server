...
@Getter
@Setter
@Table(name = "hyd_origin_training_activity_item_history")
public class HydOriginTrainingActivityItemHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTrainingActivityItemHistory that = (HydOriginTrainingActivityItemHistory) o;
