...
@Getter
@Setter
@Table(name = "hyd_la_stadium_file")
public class HydLaStadiumFile implements Serializable {
    ...
    private Integer id;  // 表主键为INT类型，对应Integer
    ...
    public boolean equals(Object o) {
        ...
        HydLaStadiumFile that = (HydLaStadiumFile) o;
