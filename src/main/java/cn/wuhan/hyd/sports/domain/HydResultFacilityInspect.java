...
@Getter
@Setter
@Table(name = "hyd_result_facility_inspect")
public class HydResultFacilityInspect implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultFacilityInspect that = (HydResultFacilityInspect) o;
