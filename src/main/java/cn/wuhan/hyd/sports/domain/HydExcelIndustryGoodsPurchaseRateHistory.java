...
@Getter
@Setter
@Table(name = "hyd_excel_industry_goods_purchase_rate_history")
public class HydExcelIndustryGoodsPurchaseRateHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryGoodsPurchaseRateHistory that = (HydExcelIndustryGoodsPurchaseRateHistory) o;
