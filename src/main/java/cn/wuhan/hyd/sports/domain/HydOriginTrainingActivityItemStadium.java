...
@Getter
@Setter
@Table(name = "hyd_origin_training_activity_item_stadium")
public class HydOriginTrainingActivityItemStadium implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTrainingActivityItemStadium that = (HydOriginTrainingActivityItemStadium) o;
