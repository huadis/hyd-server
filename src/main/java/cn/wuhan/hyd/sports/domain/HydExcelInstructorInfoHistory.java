...
@Getter
@Setter
@Table(name = "hyd_excel_instructor_info_history")
public class HydExcelInstructorInfoHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelInstructorInfoHistory that = (HydExcelInstructorInfoHistory) o;
