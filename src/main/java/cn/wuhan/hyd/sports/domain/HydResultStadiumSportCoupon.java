...
@Getter
@Setter
@Table(name = "hyd_result_stadium_sport_coupon")
public class HydResultStadiumSportCoupon implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultStadiumSportCoupon that = (HydResultStadiumSportCoupon) o;
