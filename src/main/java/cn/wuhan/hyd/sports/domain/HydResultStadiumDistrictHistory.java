...
@Getter
@Setter
@Table(name = "hyd_result_stadium_district_history")
public class HydResultStadiumDistrictHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultStadiumDistrictHistory that = (HydResultStadiumDistrictHistory) o;
