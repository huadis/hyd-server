...
@Getter
@Setter
@Table(name = "hyd_origin_training_activity_history")
public class HydOriginTrainingActivityHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTrainingActivityHistory that = (HydOriginTrainingActivityHistory) o;
