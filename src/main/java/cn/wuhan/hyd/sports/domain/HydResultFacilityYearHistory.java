...
@Getter
@Setter
@Table(name = "hyd_result_facility_year_history")
public class HydResultFacilityYearHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultFacilityYearHistory that = (HydResultFacilityYearHistory) o;
