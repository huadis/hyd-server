...
@Getter
@Setter
@Table(name = "hyd_excel_industry_employee_count")
public class HydExcelIndustryEmployeeCount implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryEmployeeCount that = (HydExcelIndustryEmployeeCount) o;
