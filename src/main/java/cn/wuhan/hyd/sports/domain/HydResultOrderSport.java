...
@Getter
@Setter
@Table(name = "hyd_result_order_sport")
public class HydResultOrderSport implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultOrderSport that = (HydResultOrderSport) o;
