...
@Getter
@Setter
@Table(name = "hyd_result_facility_district_month")
public class HydResultFacilityDistrictMonth implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydResultFacilityDistrictMonth that = (HydResultFacilityDistrictMonth) o;
