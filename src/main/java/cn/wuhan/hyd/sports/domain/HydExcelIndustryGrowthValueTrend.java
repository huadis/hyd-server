...
@Getter
@Setter
@Table(name = "hyd_excel_industry_growth_value_trend")
public class HydExcelIndustryGrowthValueTrend implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryGrowthValueTrend that = (HydExcelIndustryGrowthValueTrend) o;
