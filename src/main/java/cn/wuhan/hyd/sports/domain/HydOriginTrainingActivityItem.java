...
@Getter
@Setter
@Table(name = "hyd_origin_training_activity_item")
public class HydOriginTrainingActivityItem implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTrainingActivityItem that = (HydOriginTrainingActivityItem) o;
