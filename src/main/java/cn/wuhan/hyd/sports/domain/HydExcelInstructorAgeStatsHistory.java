...
@Getter
@Setter
@Table(name = "hyd_excel_instructor_age_stats_history")
public class HydExcelInstructorAgeStatsHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelInstructorAgeStatsHistory that = (HydExcelInstructorAgeStatsHistory) o;
