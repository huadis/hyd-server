...
@Getter
@Setter
@Table(name = "hyd_origin_training_course_history")
public class HydOriginTrainingCourseHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydOriginTrainingCourseHistory that = (HydOriginTrainingCourseHistory) o;
