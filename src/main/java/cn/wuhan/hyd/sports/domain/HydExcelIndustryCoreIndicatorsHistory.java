...
@Getter
@Setter
@Table(name = "hyd_excel_industry_core_indicators_history")
public class HydExcelIndustryCoreIndicatorsHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryCoreIndicatorsHistory that = (HydExcelIndustryCoreIndicatorsHistory) o;
