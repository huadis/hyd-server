...
@Getter
@Setter
@Table(name = "hyd_excel_industry_employee_count_history")
public class HydExcelIndustryEmployeeCountHistory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        HydExcelIndustryEmployeeCountHistory that = (HydExcelIndustryEmployeeCountHistory) o;
