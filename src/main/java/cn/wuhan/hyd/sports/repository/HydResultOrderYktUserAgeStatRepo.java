...
public interface HydResultOrderYktUserAgeStatRepo extends JpaRepository<HydResultOrderYktUserAgeStat, Long> {
    ...
    @Query(value = "SELECT * FROM hyd_result_order_ykt_userage_stat WHERE YEAR(createdTime) = ?1 ORDER BY FIELD(ageGroup, '0-5岁', '5-10岁', '10-15岁', '15-20岁', '20岁以上')", nativeQuery = true)
