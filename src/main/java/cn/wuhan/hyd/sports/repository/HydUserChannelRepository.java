...
import cn.wuhan.hyd.sports.resp.StadiumUserChannelStatResp;
 ...
 */
@Repository
public interface HydUserChannelRepository extends JpaRepository<HydUserChannel, Long> {
