 ...
 */
@Repository
public interface HydExcelInstructorAgeStatsRepo extends JpaRepository<HydExcelInstructorAgeStats, Long> {

    /**
     * 年龄统计
     */
    @Query(value = "SELECT ageInterval, personCount FROM hyd_excel_instructor_age_stats " +
