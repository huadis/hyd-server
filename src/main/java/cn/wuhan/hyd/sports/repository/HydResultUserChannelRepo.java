 ...
 */
@Repository
public interface HydResultUserChannelRepo extends JpaRepository<HydResultUserChannel, Long> {
    ...
    @Modifying
    @Query(value = "DELETE FROM hyd_result_user_channel WHERE batchNo != ?1 AND statisticalYear = ?2", nativeQuery = true)
