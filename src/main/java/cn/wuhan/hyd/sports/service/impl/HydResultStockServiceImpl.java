...
public class HydResultStockServiceImpl implements IHydResultStockService {
    ...
    public int batchSave(List<HydResultStock> stocks) {
        ...
        List<HydResultStockHistory> historyList = convertToHistoryList(stocks, batchNo);
        try {
     ...
     */
    private List<HydResultStockHistory> convertToHistoryList(
            List<HydResultStock> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultStockHistory history = new HydResultStockHistory();
                        try {
