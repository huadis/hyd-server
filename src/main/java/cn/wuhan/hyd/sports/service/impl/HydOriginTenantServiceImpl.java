 ...
 */
@Service
public class HydOriginTenantServiceImpl implements IHydOriginTenantService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public int batchSave(List<HydOriginTenant> tenants) {
        // 验证参数
        ...
        List<HydOriginTenantHistory> historyList = convertToHistoryList(tenants, batchNo);
        try {
     ...
     */
    private List<HydOriginTenantHistory> convertToHistoryList(
            List<HydOriginTenant> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydOriginTenantHistory history = new HydOriginTenantHistory();
                        try {
