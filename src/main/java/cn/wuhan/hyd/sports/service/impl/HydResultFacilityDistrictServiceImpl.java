    ...
    public int batchSave(List<HydResultFacilityDistrictReq> facilityDistricts) {
        ...
        try {
            ...
            if (refresh) {
                ...
                facilityDistrictRepo.deleteByNotBatchNo(batchNo, DateUtil.getPreviousDayYear());
            ...
            checkSaveData(facilityDistricts, refresh, querySaveCount, historySaveCount, batchNo);
