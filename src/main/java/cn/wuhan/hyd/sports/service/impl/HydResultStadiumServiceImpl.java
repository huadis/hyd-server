...
public class HydResultStadiumServiceImpl implements IHydResultStadiumService {
    ...
    public int batchSave(List<HydResultStadium> stadiums) {
        ...
        List<HydResultStadiumHistory> historyList = convertToHistoryList(stadiums, batchNo);
        try {
     ...
     */
    private List<HydResultStadiumHistory> convertToHistoryList(
            List<HydResultStadium> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultStadiumHistory history = new HydResultStadiumHistory();
                        try {
