...
public class HydResultCouponUserAgeServiceImpl implements IHydResultCouponUserAgeService {
    ...
    public int batchSave(List<HydResultCouponUserAge> couponUserAges) {
        ...
        List<HydResultCouponUserAgeHistory> historyList = convertToHistoryList(couponUserAges, batchNo);
        try {
     ...
     */
    private List<HydResultCouponUserAgeHistory> convertToHistoryList(
            List<HydResultCouponUserAge> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultCouponUserAgeHistory history = new HydResultCouponUserAgeHistory();
                        try {
