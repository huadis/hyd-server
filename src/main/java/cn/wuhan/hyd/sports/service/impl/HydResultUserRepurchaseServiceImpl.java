...
public class HydResultUserRepurchaseServiceImpl implements IHydResultUserRepurchaseService {
    ...
    public int batchSave(List<HydResultUserRepurchase> userRepurchases) {
        ...
        List<HydResultUserRepurchaseHistory> historyList = convertToHistoryList(userRepurchases, batchNo);
        try {
     ...
     */
    private List<HydResultUserRepurchaseHistory> convertToHistoryList(
            List<HydResultUserRepurchase> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultUserRepurchaseHistory history = new HydResultUserRepurchaseHistory();
                        try {
