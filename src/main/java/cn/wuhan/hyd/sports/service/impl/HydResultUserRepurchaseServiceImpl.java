    ...
    public int batchSave(List<HydResultUserRepurchaseReq> userRepurchases) {
        ...
        try {
            ...
            if (refresh) {
                ...
                userRepurchaseRepo.deleteByNotBatchNo(batchNo, DateUtil.getPreviousDayYear());
            ...
            checkSaveData(userRepurchases, refresh, querySaveCount, historySaveCount, batchNo);
