...
public class HydResultCouponUserServiceImpl extends HydBaseServiceImpl implements IHydResultCouponUserService {
    ...
    public int batchSave(List<HydResultCouponUserReq> couponUsers) {
        ...
        try {
            ...
            checkSaveData(couponUsers, refresh, historySaveCount, historySaveCount, batchNo);
    ...
    private static List<HydResultCouponUser> computeQueryList(List<HydResultCouponUserReq> couponUsers, String batchNo) {
        // 初始化累加器为0
        ...
        user.setStatisticalYear(DateUtil.getPreviousDayYear());
