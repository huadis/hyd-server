...
public class HydResultOrderServiceImpl implements IHydResultOrderService {
    ...
    public Map<String, Object> orderStat() {
        ...
        result.put("monthOrderStat", orderRepo.orderStat());
        return result;
    }
    ...
    public int batchSave(List<HydResultOrder> orders) {
        ...
        List<HydResultOrderHistory> historyList = convertToHistoryList(orders, batchNo);
        try {
     ...
     */
    private List<HydResultOrderHistory> convertToHistoryList(
            List<HydResultOrder> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultOrderHistory history = new HydResultOrderHistory();
                        try {
