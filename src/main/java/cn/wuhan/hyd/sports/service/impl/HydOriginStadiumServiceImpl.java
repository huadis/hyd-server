 ...
 */
@Service
public class HydOriginStadiumServiceImpl implements IHydOriginStadiumService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public int batchSave(List<HydOriginStadium> stadiums) {
        // 验证参数
        ...
        List<HydOriginStadiumHistory> historyList = convertToHistoryList(stadiums, batchNo);
        try {
     ...
     */
    private List<HydOriginStadiumHistory> convertToHistoryList(
            List<HydOriginStadium> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydOriginStadiumHistory history = new HydOriginStadiumHistory();
                        try {
