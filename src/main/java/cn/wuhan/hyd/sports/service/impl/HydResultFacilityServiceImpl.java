...
public class HydResultFacilityServiceImpl extends HydBaseServiceImpl implements IHydResultFacilityService {
    ...
    public int batchSave(List<HydResultFacilityReq> facilities) {
        ...
        try {
            ...
            // 是否冻结，不允许更新查询表
            if (refresh) {
                List<HydResultFacility> queryList = computeQueryList(facilities, batchNo);
            ...
            checkSaveData(facilities, refresh, historySaveCount, historySaveCount, batchNo);
    ...
    private static List<HydResultFacility> computeQueryList(List<HydResultFacilityReq> facilities, String batchNo) {
