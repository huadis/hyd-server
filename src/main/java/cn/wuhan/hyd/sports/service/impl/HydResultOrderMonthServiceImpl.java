...
public class HydResultOrderMonthServiceImpl implements IHydResultOrderMonthService {
    ...
    public int batchSave(List<HydResultOrderMonth> orderMonths) {
        ...
        List<HydResultOrderMonthHistory> historyList = convertToHistoryList(orderMonths, batchNo);
        try {
     ...
     */
    private List<HydResultOrderMonthHistory> convertToHistoryList(
            List<HydResultOrderMonth> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultOrderMonthHistory history = new HydResultOrderMonthHistory();
                        try {
