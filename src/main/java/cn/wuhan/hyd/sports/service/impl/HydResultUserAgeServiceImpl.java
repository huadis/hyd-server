...
public class HydResultUserAgeServiceImpl implements IHydResultUserAgeService {
    ...
    public int batchSave(List<HydResultUserAge> userAges) {
        ...
        List<HydResultUserAgeHistory> historyList = convertToHistoryList(userAges, batchNo);
        try {
     ...
     */
    private List<HydResultUserAgeHistory> convertToHistoryList(
            List<HydResultUserAge> sourceList,
            String batchNo) {
        try {
            return sourceList.stream()
                    .map(source -> {
                        HydResultUserAgeHistory history = new HydResultUserAgeHistory();
                        try {
