...
public class DataController {
    ...
    // ----------------------------------- 消费券总金额 -----------------------------------
    @ApiOperation("体育消费卷-消费券总金额-分页查询")
    ...
    @ApiOperation("体育消费卷-消费券总金额-根据ID查询详情")
    ...
    // ----------------------------------- 场馆预定/体育消费卷-消费券场馆预订Top -----------------------------------

    @ApiOperation("场馆预定/体育消费卷-消费券场馆预订Top-分页查询")
    ...
    @ApiOperation("场馆预定/体育消费卷-消费券场馆预订Top-根据ID查询详情")
    ...
    @ApiOperation("场馆预定/体育消费卷-消费券场馆预订Top-更新")
    ...
    @ApiOperation("体育消费卷-券用户年龄分布-分页查询")
    ...
    @ApiOperation("体育消费卷-券用户年龄分布-根据ID查询详情")
    ...
    @ApiOperation("体育消费卷-券用户分析-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-设施各区月数据-分页查询")
    ...
    @ApiOperation("体育基础设施-设施各区月数据-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-设施各区月数据-增加")
    ...
    public ResponseEntity<HydResultFacilityDistrictMonth> facilityDistrictMonthAdd(
            @ApiParam(value = "设施各区月数据", required = true) @Valid @RequestBody HydResultFacilityDistrictMonth facilityDistrictMonth) {
        return ResponseEntity.ok(hydFacilityDistrictMonthService.save(facilityDistrictMonth));
    }

    @ApiOperation("体育基础设施-设施各区月数据-删除")
    ...
    @ApiOperation("体育基础设施-设施各区月数据-更新")
    ...
    @ApiOperation("体育基础设施-设施各区分布-分页查询")
    ...
    @ApiOperation("体育基础设施-设施各区分布-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-巡检动态-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-设施全貌-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-健身点位年数据-分页查询")
    ...
    @ApiOperation("体育基础设施-健身点位年数据-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-健身点位年数据-更新")
    ...
    @ApiOperation("体育消费卷-订单趋势-根据ID查询详情")
    ...
    @ApiOperation("场馆预定-订单数量-根据ID查询详情")
    ...
    // ----------------------------------- 场馆预定/体育消费卷-项目消费券订单金额Top5 -----------------------------------

    @ApiOperation("场馆预定/体育消费卷-项目消费券订单金额Top5-分页查询")
    ...
    @ApiOperation("场馆预定/体育消费卷-项目消费券订单金额Top5-根据ID查询详情")
    ...
    @ApiOperation("场馆预定/体育消费卷-项目消费券订单金额Top5-增加")
    @AnonymousPostMapping("/orderSport/add")
    public ResponseEntity<HydResultOrderSport> orderSportAdd(
            @ApiParam(value = "项目消费券订单金额Top5", required = true) @Valid @RequestBody HydResultOrderSport orderSport) {
        return ResponseEntity.ok(hydOrderSportService.save(orderSport));
    }

    @ApiOperation("场馆预定/体育消费卷-项目消费券订单金额Top5-删除")
    ...
    @ApiOperation("场馆预定/体育消费卷-项目消费券订单金额Top5-更新")
    ...
    @ApiOperation("体育消费卷-场馆消费券订单金额Top5-分页查询")
    ...
    @ApiOperation("体育消费卷-场馆消费券订单金额Top5-根据ID查询详情")
    ...
    @ApiOperation("体育消费卷-场馆消费券订单金额Top5-增加")
    @AnonymousPostMapping("/orderStadium/add")
    public ResponseEntity<HydResultOrderStadium> orderStadiumAdd(
            @ApiParam(value = "场馆消费券订单金额Top5", required = true) @Valid @RequestBody HydResultOrderStadium orderStadium) {
        return ResponseEntity.ok(hydOrderStadiumService.save(orderStadium));
    }

    @ApiOperation("体育消费卷-场馆消费券订单金额Top5-删除")
    ...
    @ApiOperation("体育消费卷-场馆消费券订单金额Top5-更新")
    ...
    @ApiOperation("场馆预定-在线场馆各区情况-分页查询")
    ...
    @ApiOperation("场馆预定-在线场馆各区情况-根据ID查询详情")
    ...
    @ApiOperation("体育基础设施-电子地图-根据ID查询详情")
    ...
    @ApiOperation("场馆预定-在线场馆数量-根据ID查询详情")
    ...
    // ----------------------------------- 体育消费卷/场馆预定-运动项目分布用券数占比 -----------------------------------

    @ApiOperation("体育消费卷/场馆预定-运动项目分布用券数占比-分页查询")
    ...
    @ApiOperation("体育消费卷/场馆预定-运动项目分布用券数占比-根据ID查询详情")
    ...
    @ApiOperation("体育消费卷/场馆预定-运动项目分布用券数占比-更新")
    ...
    @ApiOperation("体育消费卷-消费券领用券-分页查询")
    ...
    @ApiOperation("体育消费卷-消费券领用券-根据ID查询详情")
    ...
    @ApiOperation("体育消费卷-消费券领用券-增加")
    @AnonymousPostMapping("/stock/add")
    public ResponseEntity<HydResultStock> stockAdd(
            @ApiParam(value = "消费券领用券", required = true) @Valid @RequestBody HydResultStock stock) {
        return ResponseEntity.ok(hydStockService.save(stock));
    }

    @ApiOperation("体育消费卷-消费券领用券-删除")
    ...
    @ApiOperation("场馆预定-年龄占比-根据ID查询详情")
    ...
    @ApiOperation("场馆预定-用户来源渠道-根据ID查询详情")
    ...
    @ApiOperation("场馆预定-每月新增用户-根据ID查询详情")
    ...
    @ApiOperation("场馆预定-复购率-根据ID查询详情")
    ...
    @ApiOperation("场馆预定-男女占比-根据ID查询详情")
    ...
    public ResponseEntity<HydResultOrderYktDistrictStat> yktDistrictStatAdd(
            @ApiParam(value = "各区机构数量统计", required = true) @Valid @RequestBody HydResultOrderYktDistrictStat districtStat) {
    ...
    public ResponseEntity<HydResultOrderYktCourseStat> yktCourseStatAdd(
            @ApiParam(value = "课程热度排行TOP5", required = true) @Valid @RequestBody HydResultOrderYktCourseStat yktCourseStat) {
    ...
    public ResponseEntity<HydResultOrderYktProjectStat> yktProjectStatAdd(
            @ApiParam(value = "热门项目机构数量统计", required = true) @Valid @RequestBody HydResultOrderYktProjectStat yktProjectStat) {
    ...
    public ResponseEntity<HydResultOrderYktStadiumStat> yktStadiumStatAdd(
            @ApiParam(value = "培训场馆销售统计TOP10", required = true) @Valid @RequestBody HydResultOrderYktStadiumStat yktStadiumStat) {
    ...
    public ResponseEntity<HydResultOrderYktUserAgeStat> yktUserAgeStatAdd(
            @ApiParam(value = "年龄分布", required = true) @Valid @RequestBody HydResultOrderYktUserAgeStat yktUserAgeStat) {
    ...
    public ResponseEntity<HydResultOrderYktUserSexStat> yktUserSexStatAdd(
            @ApiParam(value = "性别统计", required = true) @Valid @RequestBody HydResultOrderYktUserSexStat yktUserSexStat) {
    ...
    public ResponseEntity<HydResultEventsOverviewStat> eventsOverviewStatAdd(
            @ApiParam(value = "总览信息表", required = true) @Valid @RequestBody HydResultEventsOverviewStat eventsOverviewStat) {
    ...
    public ResponseEntity<HydResultEventsMonthCountStat> eventsMonthCountStatAdd(
            @ApiParam(value = "各月办赛数据表", required = true) @Valid @RequestBody HydResultEventsMonthCountStat eventsMonthCountStat) {
    ...
    public ResponseEntity<HydResultEventsSportItemTop> eventsSportItemTopAdd(
            @ApiParam(value = "赛事数量TOP5项目表", required = true) @Valid @RequestBody HydResultEventsSportItemTop eventsSportItemTop) {
    ...
    public ResponseEntity<HydResultEventsParticipantLevel> eventsParticipantLevelAdd(
            @ApiParam(value = "参赛人数人档表", required = true) @Valid @RequestBody HydResultEventsParticipantLevel eventsParticipantLevel) {
    ...
    public ResponseEntity<HydResultInstructorLevel> instructorLevelAdd(
            @ApiParam(value = "级别统计", required = true) @RequestBody HydResultInstructorLevel instructorLevel) {
    ...
    public ResponseEntity<HydResultInstructorOverview> instructorOverviewAdd(
            @ApiParam(value = "概览", required = true) @RequestBody HydResultInstructorOverview instructorOverview) {
    ...
    public ResponseEntity<HydResultInstructorRegion> instructorRegionAdd(
            @ApiParam(value = "各区指导人员统计", required = true) @RequestBody HydResultInstructorRegion instructorRegion) {
    ...
    public ResponseEntity<HydResultInstructorServiceProject> instructorServiceProjectAdd(
            @ApiParam(value = "项目统计", required = true) @RequestBody HydResultInstructorServiceProject instructorServiceProject) {
    ...
    public ResponseEntity<HydResultInstructorServiceProjectTop> instructorServiceProjectTopAdd(
            @ApiParam(value = "指导项目统计TOP15", required = true) @RequestBody HydResultInstructorServiceProjectTop instructorServiceProjectTop) {
    ...
    public ResponseEntity<HydResultInstructorUserSex> instructorUserSexAdd(
            @ApiParam(value = "性别统计", required = true) @RequestBody HydResultInstructorUserSex instructorUserSex) {
    ...
    public ResponseEntity<HydResultLaStadiumDistrict> laStadiumDistrictAdd(
            @ApiParam(value = "各区场馆数量统计", required = true) @RequestBody HydResultLaStadiumDistrict laStadiumDistrict) {
    ...
    public ResponseEntity<HydResultLaStadiumSportName> laStadiumSportNameAdd(
            @ApiParam(value = "项目类型统计", required = true) @RequestBody HydResultLaStadiumSportName laStadiumSportName) {
    ...
    public ResponseEntity<HydResultLaStadiumSportNameTop> laStadiumSportNameTopAdd(
            @ApiParam(value = "项目类型占比TOP10统计", required = true) @RequestBody HydResultLaStadiumSportNameTop laStadiumSportNameTop) {
    ...
    public ResponseEntity<HydExcelSportsOrgDistrictStat> sportsOrgDistrictStatAdd(
            @ApiParam(value = "区属统计", required = true) @RequestBody HydExcelSportsOrgDistrictStat sportsOrgDistrictStat) {
